...
print(sp.Qnormalize(Q1), sc.Qnormalize(Q1))
print(sp.Qnormalize(Q4), sc.Qnormalize(Q4))
print(sp.Qnorm(Q1), sc.Qnorm(Q1))
print(sp.Qnorm(Q4), sc.Qnorm(Q4))
...
print(sp.Q2EV(Q4))
print('EV2Q')
print("sp: ", sp.EV2Q(EV1,1e-7), "sc:  ", sc.EV2Q(EV1,1e-7))
print("sp: ", sp.EV2Q(EV2,1e-7), "sc:  ", sc.EV2Q(EV2,1e-7))
print("sp: ", sp.EV2Q(EV3,1e-7), "sc:  ", sc.EV2Q(EV3,1e-7))
print("sp: ", sp.EV2Q(EV4,1e-7), "sc:  ", sc.EV2Q(EV4,1e-7))
